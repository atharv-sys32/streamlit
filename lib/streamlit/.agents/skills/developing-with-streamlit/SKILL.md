...
| **Agent reasoning / task-progress UI** — `st.status` for showing the progress of a long-running or multi-step task (tool calls, retrieval, reasoning steps) | read `references/chat-ui.md` |
